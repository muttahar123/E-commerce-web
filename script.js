  ...
  <div class="container flex px-5 py-24 mx-auto">
    <div class="lg:w-4/5 my-1  mx-auto flex flex-wrap">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        ...
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">${products[i].title}</h1>
        <div class="flex mb-4">
        ...
        <p class="leading-relaxed">${products[i].description}</p>
        <p class="leading-relaxed">${products[i].category}</p>
        ...
        <div class="flex">
          ...
          <svg id="heartIcon" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="heart-icon empty" viewBox="0 0 24 24" onclick="toggleHeartColor(this)">
...
function Addtocart(element){
    if (element.innerHTML == 'Added') {
      ...
      cartNumber.innerHTML = parseInt(cartNumber.innerText) +1;
      element.innerHTML = "Added"
    }
}
function toggleHeartColor(ele) {
  // var heartIcon = document.getElementById("heartIcon");
  ele.classList.toggle("filled");
  ele.classList.toggle("empty");
}
